...
local trpTarget = CreateFrame("Frame")
...
trpTarget.button:SetSize(15,15)
...
trpTarget.button.ring:SetPoint("CENTER", trpTarget.button.tex, "CENTER", 0, 0)
trpTarget.button.ring:SetSize(19,19)
trpTarget.button.ring:SetAtlas("communities-ring-gold")
trpTarget.button:Hide()
--PlayerName

local trpPlayer = CreateFrame("Frame")
...
trpPlayer.button:SetSize(15,15)
...
trpPlayer.button.ring:SetPoint("CENTER", trpPlayer.button.tex, "CENTER", 0, 0)
trpPlayer.button.ring:SetSize(19,19)
trpPlayer.button.ring:SetAtlas("communities-ring-gold")



function trpPlayer.fadeout()
	UIFrameFadeOut(trpPlayer.button, 2, 1, 0)
end
...
function trpPlayer.fadein()
	UIFrameFadeIn(trpPlayer.button, 1, 0, 1)
end
...
trpPlayer:SetScript("OnEvent", function(self, event)
	...
	if event == "PLAYER_REGEN_DISABLED" then
		...
		trpPlayer.fadeout()
		C_Timer.After(2, trpPlayer.hide)
	elseif event == "PLAYER_REGEN_ENABLED" then
		print("exiting combat")
		trpPlayer.fadein()
		C_Timer.After(1, trpPlayer.show)
	end
end);
